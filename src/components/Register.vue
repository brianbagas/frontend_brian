                        ...
                        <v-card-text class="pt-4">
                            <div>
                                <v-form v-model="valid" ref="form">
                                    <v-text-field label="Nama" v-model="nama" :rules="fieldRules" required></v-text-field>
                                    ...
                                    <v-text-field label="Alamat" v-model="alamat" :rules="fieldRules" required></v-text-field>
                                    <v-text-field label="Nomor Telepon" v-model="no_telp" :rules="fieldRules" counter required></v-text-field>
